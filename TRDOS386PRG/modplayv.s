...
set_vesa_mode_101h_ok:
	...
	; set text mode and write err msg
	call	set_text_mode
...
;	int     31h
	...
	; 27/12/2024
	; Set Master Volume Level (to 29) -max:31-
	sys	_audio, 0B00h, 1D1Dh
...
modp_gs:
	...
	;;;
	; 27/12/2024
	cmp	byte [volume_change], 0
	jna	short q_loop

	call	change_volume_level
	;;;
q_loop:
...
;q_return:
	...
	;;;
	; 27/12/204 (ref: modplayx.s - 06/06/2024)
...
DrawLoop:       
	...
	; 27/12/2024
	;shl	ebx, 1
	shl	ebx, 2	; max. 255*4 (row 112 + w_row 0 to 255)
	mov	edi, [RowOfs+ebx] ; row start position/offset
	add	edi, ecx	; column
	;mov	ebx, edx
	;mov	[Scope+ebx], edi
	; 27/12/2024
...
change_volume_level:
	...
	; Set Master Volume Level
	sys	_audio, 0B00h
	mov	byte [volume_change], 0 ; reset volume change (required) flag
	retn
...
g_buff:		;resb 320*4 ; 24/06/2017
		resb 640*4 ; 27/12/2024
