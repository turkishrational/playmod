; ****************************************************************************
; modplay7.s (for TRDOS 386)
; ----------------------------------------------------------------------------
; MODPLAY7.PRG ! SOUND BLASTER 16 MOD PLAYER & VGA DEMO program by Erdogan TAN
;
; 24/06/2017
;
; [ Last Modification: 20/10/2017 ]  !!! STEREO MOD PLAYING !!!
;
...
r_loop:
	...
	;
	sys	_audio, 0F00h, 320*4, g_buff ; 20/10/2017 (320*4)
ScopeLoop:
...
g_buff:
		resb 320 * 4 ; 20/10/2017 (stereo, 16 bits)
