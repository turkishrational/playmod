...
; 19/06/2017
BUFFERSIZE equ 32768 ; 04/12/2023 - modification for kernel buffer test
; 27/11/2023
...
r_loop:
	...
	; 27/11/2023
	;mov	ecx, DMA_Buffer + (131072 - (256*4))
	cmp	esi, ecx 
	jna	short _4
	mov	esi, ecx
_4:
...
MoveChunk:
	...
	; 18/10/2017
	cmp	byte [numtracks], 4
	jna	short _4_channels_mix ; 27/11/2023
...
DMA_Buffer:	resb 65536   ; 04/12/2023 (kernel buffer test)
		     ; (for using sb16 dma buffer as ac97 dma buffer)		
		;resb 131072 ; 27/11/2023	
file_buffer:
		resb 65536*6
EOF: