; ****************************************************************************
; tmodplay.s (for TRDOS 386)
; ----------------------------------------------------------------------------
; TMODPLAY.PRG ! SOUND BLASTER 16 MOD PLAYER & VGA DEMO program by Erdogan TAN
;
; 21/10/2017
;
; [ Last Modification: 29/10/2017 ]  !!! STEREO MOD PLAYING !!!
;
...
;
; Modified from 'modplay7.s' (MODPLAY7.PRG) source code by Erdogan Tan
; (20/10/2017). ((Stereo mod playing with TRDOS 386 audio system calls...))
;
...
;	mov	cl, 4
;	rep	stosw
;	add	ax, 80 ; 640 pixels (80*8 bits)
;	dec	ebx
;	jnz	short MakeOfs
...
r_loop:
	...
	;
	;sys	_audio, 0F00h, 256*4, g_buff ; 23/10/2017 (256*4)
...
Sample_Rate:
MixSpeed:	dw 22050 ; Hz ; 19/10/2017
...
; 28/10/2017
;g_buff:
;		resb 256 * 4 ; 23/10/2017 (stereo, 16 bits)
